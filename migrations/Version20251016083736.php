 ...
 */
final class Version20251016083736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_id INT DEFAULT NULL, ADD enabled TINYINT(1) NOT NULL, ADD published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author_id, DROP enabled, DROP published');
    }
}
